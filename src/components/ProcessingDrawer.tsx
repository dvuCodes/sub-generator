...
export function ProcessingDrawer({
  ...
  return (
    <>
      <div className="fixed inset-0 z-40 bg-foreground/5 backdrop-blur-[2px]" />
      <section className="tui-drawer fixed inset-x-0 bottom-0 z-50">
        <div className="mx-auto w-full max-w-5xl px-6 pb-6">
          <div className="overflow-hidden rounded-2xl border border-border bg-card/95 shadow-2xl">
